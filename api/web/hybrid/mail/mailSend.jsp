...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko" xml:lang="ko">
	...
	<body onload="init();">
		...
		<form name="sendForm" method="post">
			...
			<div class="container">				
				<div class="title_box">
					<div class="btn_l"><a href="/hybrid/mail/mailMdnList.do" class="btn2" title="<tctl:msg key="mail.receivenoti"/>"><span><tctl:msg key="mail.receivenoti"/></span></a></div><!-- 수신확인  -->
					<div class="btn_r"><a href="/hybrid/mail/folderList.do" class="btn2" title="<tctl:msg key="mail.folderlist"/>"><span><tctl:msg key="mail.folderlist"/></span></a></div><!-- 메일함 목록 -->
				</div>				
				...
				<c:if test="${!sendResultVO.errorOccur}">
					...
					<div class="msg" id="document_body">
						...
						<div class="btn_area">
							<a href="/hybrid/mail/mailWrite.do" class="btn3" title="<tctl:msg key="mail.rewrite"/>"><span><tctl:msg key="mail.rewrite"/></span></a><!-- 새로운 메일쓰기 -->
							<a href="/hybrid/mail/mailList.do?folderName=Inbox" class="btn3" title="<tctl:msg key="mail.goinbox"/>"><span><tctl:msg key="mail.goinbox"/></span></a><!-- 받은메일함 이동 -->
						</div>
					</div>
					</c:if>
					<c:if test="${sendResultVO.checkErrorOccur}">
				...
				<c:if test="${sendResultVO.errorOccur}">
					<div class="msg" id="document_body">
						...
						<div class="btn_area">
							<a href="/hybrid/mail/mailList.do?folderName=Drafts" class="btn3" title="<tctl:msg key="mail.godraft"/>"><span><tctl:msg key="mail.godraft"/></span></a><!-- 임시 보관함이동 -->
							<a href="/hybrid/mail/mailList.do?folderName=Inbox" class="btn3" title="<tctl:msg key="mail.goinbox"/>"><span><tctl:msg key="mail.goinbox"/></span></a><!-- 받음메일함이동 -->
						</div>
					</div>
				</c:if>
			</div>					
