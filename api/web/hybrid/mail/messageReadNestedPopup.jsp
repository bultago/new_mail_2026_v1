							...
							<c:choose>
				   			...
				   			<c:if test="${fileData.size75 > 0 }">
								 ...
								 <c:if test="${fileType=='eml'}">
                                      <a href="javascript:readNestedMessage('${uid}','${folder}','${fileData.path}')" class="btn_save" style="margin-left:10px;" title="<tctl:msg key="menu.open"/>">
                                          <tctl:msg key="menu.open"/>
                                      </a>
	                             </c:if>
                                 <c:if test="${fileType!='eml'}">
                                      <a href="javascript:downLoadAttach('${uid}','${folder}','${fileData.path}')" class="btn_save" style="margin-left:10px;" title="<tctl:msg key="menu.open"/>">
