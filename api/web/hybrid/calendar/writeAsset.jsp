				...
				<div>
					...
					<table class="reserv_info" id="schedulerContents" style="display:none;">
						...
						<tr>
							...
							<td><input type="text" name="location" id="location" class="it_full"/></td>
						</tr>
						<tr>
							<th><tctl:msg key="scheduler.search.content" bundle="scheduler"/></th>
							<td><textarea name="content" id="content" rows="6" cols="" class="tx_full"></textarea></td>
						</tr>
						<tr>
							<th></th>
