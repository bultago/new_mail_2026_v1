...
var UploadBasicControl = Class.create({
	...
	getControlFile:function(fileId){		
		return null;
	},
	...
	makeListControl:function(){
		...
		var swfTable_Tr1 = jQuery('<tr></tr>');
			...
			(this.controlType == "power") ? swfTable_Tr1.append('<th style="width:250px;">'+mailMsg.mail_attach_type+'</th>') : swfTable_Tr1.append('');
