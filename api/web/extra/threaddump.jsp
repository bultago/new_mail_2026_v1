...
%>
<%
	String mailadm = request.getParameter("mailadm");
	if(!"tims".equalsIgnoreCase(mailadm)){
		%>
		<script>alert("mailadm pw ?");</script>
		<%
		return;
	}
%>
...
<body>
<%
	String uri = request.getRequestURI()+"?mailadm=tims";
...
<form method="get">
	...
	<input type="hidden" name="mailadm" value="tims" />  
	<select name="state">
