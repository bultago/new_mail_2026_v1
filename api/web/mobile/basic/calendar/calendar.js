...
function searchSchedulerAsset() {
	var url="/mobile/calendar/assetCalendar.do";
...
var calendarMenu = [];
calendarMenu.push({id:"calendar_menu_month",name:schedulerMsg.scheduler_tab_monthly,depth:0,link:"/mobile/calendar/monthCalendar.do"});
calendarMenu.push({id:"calendar_menu_week",name:schedulerMsg.scheduler_tab_weekly,depth:0,link:"/mobile/calendar/weekCalendar.do"});
calendarMenu.push({id:"calendar_menu_asset",name:schedulerMsg.scheduler_asset_001,depth:0,link:"/mobile/calendar/writeAssetCalendar.do"});
