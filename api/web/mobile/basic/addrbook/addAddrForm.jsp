...
<head>
	...
	function saveMember(){
		...
		f.action = (addType == "add")?"/mobile/addr/addAddrSave.do":"/mobile/addr/updateAddrSave.do";
		f.submit();		
	}
...
<body>
	<div class="m_tms_wrap">
			...
			<div class="container">
			<form name="addrSaveForm" method="post">
			...
			<div class="write_wrap">
				...
				<table class="write_form">
					...
					<tr>
						<th><tctl:msg key="addr.info.label.029" bundle="addr"/></th>
						<td>
							<input type="text" name="mOfficeHomepage" id="mOfficeHomepage" class="it_full" value="${fn:escapeXml(member.officeHomepage)}"/>							
						</td>
					</tr>
					<tr class="space"><th></th><td></td></tr>
					</tbody>
