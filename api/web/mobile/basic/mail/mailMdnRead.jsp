	...
	<head>
		...
		<script type="text/javascript">			
			...
			function recallMsg(email) {
				...
				var url="/mobile/mail/mailMdnRecall.do";
		...
		<div class="wrapper">	
			...
			<div class="container">
				<div class="title_box">
					...
					<div class="btn_r"><a id="link_2" href="/mobile/mail/mailWrite.do" class="btn2" title="<tctl:msg key="mail.write"/>"><span><tctl:msg key="mail.write"/></span></a></div>
				</div>
