	...
	<head>
		...
		<script type="text/javascript">			
			...
			function replyContent() {
				...
				f.method = "post";
				f.action = "/mobile/bbs/bbsContentWrite.do";
				f.submit();
			}			
			function modifyContent() {
				...
				// f.isModify.value="true";
				 f.method = "post";
				 f.action = "/mobile/bbs/bbsContentModify.do";
				 f.submit();
			}
			function deleteContent() {
				...
				var f = document.contentForm;
				f.action = "/mobile/bbs/bbsContentDelete.do";
				f.method = "post";
				f.submit();
			}
			function getReplyMessage() {
				var url = "/mobile/bbs/bbsContentViewReply.do";
			...
			function saveReplyMessage() {
				...
				var url = "/mobile/bbs/bbsContentSaveReply.do";
			...
			function deleteReplyMessage(replyId) {
				var url = "/mobile/bbs/bbsContentDeleteReply.do";
			...
			<div class="container">
				...
				<div class="title_box">
					<div class="btn_l">	
						...
						<a href="/mobile/bbs/bbsContentList.do?bbsId=${contentVo.bbsId}" class="btn2"><span><tctl:msg key="bbs.mobile.006" bundle="bbs"/></span></a>						
