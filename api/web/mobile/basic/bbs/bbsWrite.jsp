...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko" xml:lang="ko">
	<head>
		...
		function saveContent() {
		    ...
		    var confirmMsg = "";
		    if ("${isModify}" == "true") {
		    	f.action = "/mobile/bbs/bbsContentUpdate.do";
		    	confirmMsg = bbsMsg.bbs_content_modify_confirm;
		    } 
		    else {
		    	f.action = "/mobile/bbs/bbsContentSave.do";
	...
	<body>
		<div class="wrapper">		
			...
			<div class="container">
				...
				<div class="title_box">
					<div class="btn_l">
						<a class="btn2" href="/mobile/bbs/bbsContentList.do?bbsId=${bbsId}"><span><tctl:msg key="comn.list" bundle="common"/></span></a>
				...
				<div class="write_wrap">
					...
					<table class="write_form">
						...
						<tr>
							...
							<td>
								<textarea rows="6" cols="" class="tx_full" id="contentText" name="contentText">${bbsContentVo.htmlContent}</textarea>
