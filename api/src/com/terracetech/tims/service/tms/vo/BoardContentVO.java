...
public class BoardContentVO {
	...
	BoardContentVO[] prevContent = null;
	BoardContentVO[] nextContent = null;
	...
	public BoardContentVO[] getPrevContent() {
		return prevContent;
	}

	public void setPrevContent(BoardContentVO[] prevContent) {
		this.prevContent = prevContent;
	}

	public BoardContentVO[] getNextContent() {
		return nextContent;
	}

	public void setNextContent(BoardContentVO[] nextContent) {
