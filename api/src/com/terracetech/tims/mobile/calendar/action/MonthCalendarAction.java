...
public class MonthCalendarAction extends BaseAction {

	private static final long serialVersionUID = -8910904667084375207L;
	...
	public String execute() throws Exception {
		...
		try{
		calendar = calendarService.getMonthCalendar(calendarCondVo, user);
