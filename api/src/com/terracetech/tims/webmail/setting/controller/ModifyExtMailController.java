...
@Controller("modifyExtMailController")
public class ModifyExtMailController {
	...
	public String execute(
		...
		extMailVo.setExtMailId(Integer.parseInt(extMailId));
		...
		boolean result = settingManager.updateExtMail(extMailVo);
