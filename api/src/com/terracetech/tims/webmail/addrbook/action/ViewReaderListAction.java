...
public class ViewReaderListAction extends BaseAction {
	...
	private AddressBookReaderVO[] readerList;
	...
	public AddressBookReaderVO[] getReaderList() {
		return readerList;
	}
	...
	public String executePart() throws Exception {
		...
		total = manager.readAddressBookReaderListCount(bookSeq, searchType,keyWord);
		List<AddressBookReaderVO> list = manager.readAddressBookReaderList(bookSeq, page, pageBase, searchType,keyWord);

		readerList = list.toArray(new AddressBookReaderVO[list.size()]);
