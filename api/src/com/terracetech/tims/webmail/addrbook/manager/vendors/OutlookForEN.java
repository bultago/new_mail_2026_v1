...
public class OutlookForEN implements IEmailVendor {
	...
	public StringBuffer getAddrCSVDownload(List<AddressBookMemberVO> list) {
		...
		sb.append(resource.getMessage("addr.outlook.004") + ",");	//ÀüÀÚ ¸ÞÀÏ ÁÖ¼Ò
		
		sb.append(resource.getMessage("addr.outlook.005") + ",");	//Áý ¹øÁö
		sb.append(resource.getMessage("addr.outlook.006") + ",");	//Áý ÁÖ¼Ò ±¸/±º/½Ã
		sb.append(resource.getMessage("addr.outlook.007") + ",");	//Áý ÁÖ¼Ò ¿ìÆí ¹øÈ£
		sb.append(resource.getMessage("addr.outlook.008") + ",");	//Áý ÁÖ¼Ò ½Ã/µµ
		sb.append(resource.getMessage("addr.outlook.009") + ",");	//Áý ÁÖ¼Ò ±¹°¡/Áö¿ª
		sb.append(resource.getMessage("addr.outlook.010") + ",");	//Áý ÀüÈ­ ¹øÈ£
		
		sb.append(resource.getMessage("addr.outlook.012") + ",");	//ÈÞ´ëÆù
