...
CURRENT_PAGE_NAME = "MAILREADPOPUP";
var isAllFolder = false;
var isPopupload = false;
var isLocalMail = ${localmail};
...
<body class="popupBody" onload="loadMessageReadPage()">
<div class="popup_style2" id="readPopupFrame">
	<div class="title">
		<span>
	...
	<div class="TM_modal_content_wrapper">	
		...
		<jsp:include page="messageRead.jsp" flush="true" />		
		</div>
...
<div id="m_sourceView"  title="<tctl:msg key="mail.sourceview"/>" style="width:100%; display:none">
	<table cellpadding="0" cellspacing="0" class="jq_innerTable">		
		<col></col>	
		<tr>		
		<td height="400px"><iframe name="sourceFrame" id="sourceFrame" src="about:blank" frameborder="0" width="100%" height="400px"></iframe></td>
		</tr>
	</table>	
</div>
