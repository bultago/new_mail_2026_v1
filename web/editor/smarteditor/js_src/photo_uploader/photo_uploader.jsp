...
.pop_container2{padding:20px 0px 0px 40px}
.pop_container2 .dsc{margin-top:6px;color:#666;line-height:18px}
.pop_container2 .dsc strong{color:#13b72a}
.upload{margin:0 0 0 0;_margin:0;padding:6px;border:solid 1px #d5d5d5;color:#a1a1a1;font-size:12px;length:300px;}
:root  .upload{}
</style>
</head>
<body>
<div id="pop_wrap">
    ...
    <div id="pop_container2" class="pop_container2">
        <!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="/file/uploadSmartAttachImageAction.do" method="post" enctype="multipart/form-data" onSubmit="return false;">
        <div id="pop_content2">
			<input type="file" class="upload" id="uploadInputBox" name="NewFile">
            <p class="dsc" id="info"><tctl:msg key="mail.editor.image.upload.noti"/></p>
        </div>
        </form>
        <!-- //content -->
    </div>
    ...
    <div id="pop_footer">
        <div class="btn_area">
            ...
            <a href="javascript:if(parent){ parent.modalPopupImageUploadClose(); } else { window.close();}"><img src="./img/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
