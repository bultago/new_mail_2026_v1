...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		...
		this.htPopupOption.sProperties = "left="+left+",top="+top+",width="+popupWidth+",height="+popupHeight+",scrollbars=yes,location=no,status=0,resizable=no";
	...
	makePopupURL : function(){
		var sPopupUrl = "/editor/smarteditor/js_src/photo_uploader/photo_uploader.jsp";
