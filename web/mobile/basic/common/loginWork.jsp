		...
		<script type="text/javascript">
			...
			function loginProcess() {
				...
				if(f.secureLoginCheck.checked){
					f.action = "https://"+this.location.host+"/mobile/common/login.do";
				}
			...
			function changeLanguage(language){
				location.href = "/common/welcome.do?language="+language;
			}
		</script>
	</head>
	<body onload="init();">
		<form name="loginForm" action="/mobile/common/login.do" method="post">
			...
			<div class="wrapper">
						...
						<div id="language_box" class="languageBox">
							<div class="languageAbBox" style="right:0px;top:30px;">
								<div class="languageInnerBox">
									<ul>
										<li><a href="javascript:;" onclick="changeLanguage('ko')"><tctl:msg key="conf.profile.23" bundle="setting"/></a></li>
										<li><a href="javascript:;" onclick="changeLanguage('en')"><tctl:msg key="conf.profile.24" bundle="setting"/></a></li>
										<li><a href="javascript:;" onclick="changeLanguage('jp')"><tctl:msg key="conf.profile.language.japanese" bundle="setting"/></a></li>
									</ul>
								</div>
							</div>
						</div>
				...
				<div class="footer">
					<div class="footer_btn">
						...
						<a href="javascript:chageMailMode('pc', '<%=language %>');" class="btn2"><span>PC <tctl:msg key="comn.version" bundle="common"/></span></a>
						<%}%>
					</div>					
				</div>
			</div>
