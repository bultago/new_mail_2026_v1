...
<body onload="init()">
	...
	<div class="wrapper">
		<div class="header">
			...
			<div class="hh"><h2><tctl:msg key="comn.top.today" bundle="common"/></h2></div>
		</div>		
		<div class="container">
			<div class="my_home">
				<div class="my_info">
				...
				<ul class="my_list">
					<li>
						<div>
							<a href="/mobile/mail/mailList.do?page=1&flag=U&folderName=all" class="mail">
					...
					<li>
						<div class="last">
							<a href="/mobile/calendar/monthCalendar.do" class="schedule">
						...
						<ul class="today_schedule_list">						
							...
							<c:forEach items="${todaySchedule}" var="schedule">							
								<li style="cursor:pointer;" onclick="document.location='/mobile/calendar/viewCalendar.do?schedulerId=${schedule.schedulerId}&date=<fmt:formatDate value="${today}" pattern="yyyyMMdd"/>'">${schedule.title}</li>
							</c:forEach>
							</c:if>
			...
			<%@include file="/mobile/basic/common/icon_bottom.jsp" %>
		</div>
