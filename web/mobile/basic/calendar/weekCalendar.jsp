	...
	<body>
		<div class="wrapper">		
			...
			<div class="container">
				<div class="title_box">
					<div class="date_num">
						<a class="btn_prev" href="/mobile/calendar/weekCalendar.do?date=${calendar.preday}"></a>
						<span class="date">
					...
					<c:forEach var="date" items="${calendar.dateList}" varStatus="loop">
						<li>
							<h4 class="date <c:if test="${date eq calendar.today}"> today </c:if> <c:if test="${loop.index == 0}"> border_none </c:if>">
								...
								<a class="btn2" href="/mobile/calendar/writeCalendar.do?date=${date}&listType=week"><span><tctl:msg key="comn.add" bundle="common"/></span></a>
							</h4>
							<ul class="schedule_list">
								...
								<c:forEach var="calendarInfo" items="${calendar.calendarInfos}">
									...
									<c:when test="${date eq calendarInfo.drowStartDate}">
										...
										<li>
											<a href="/mobile/calendar/viewCalendar.do?schedulerId=${calendarInfo.schedulerId}">
