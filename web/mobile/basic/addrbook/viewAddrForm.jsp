				...
				<table class="write_form">
					...
					<tr>
						...
						<td>
							<table class="tb_date">
								<tbody>
								<tr>
									<td style="text-align:center;padding:0px;">${fn:split(fn:escapeXml(member.homePostalCode),'-')[0]}</td>
									<td class="btn_calendar_wrap">~</td>
									<td style="text-align:center;padding:0px;">${fn:split(fn:escapeXml(member.homePostalCode),'-')[1]}</td>
								</tr>
								</tbody>
							</table>
						</td>
					...
					<tr>
						...
						<td>
							...
							<a href="${fn:escapeXml(member.officeHomepage)}" target="_blank">${fn:escapeXml(member.officeHomepage)}</a>
							</c:if>
							</div>
						</td>
					</tr>
