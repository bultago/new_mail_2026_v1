...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko" xml:lang="ko">
	<head>
		...
		<script type="text/javascript">			
			...
			function deleteMessage() {
				...
				var url="/hybrid/mail/mailMdnWork.do";
				var paramArray = [];
	...
	<body>
		<div class="wrapper">	
			...
			<div class="container">
				<div class="title_box">
					<div class="btn_l"><a href="/hybrid/mail/folderList.do" class="btn2" title="<tctl:msg key="mail.folderlist"/>"><span><tctl:msg key="mail.folderlist"/></span></a></div>
