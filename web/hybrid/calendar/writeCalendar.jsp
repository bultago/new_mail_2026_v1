...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ko" xml:lang="ko">
	...
	<body>
		<div class="wrapper" id="bodyWrapper">		
			...
			<div class="container">
				<form name="writeForm" method="post" onSubmit="return saveCalendar()">
				...
				<div class="title_box">
					<div class="btn_l">
						<a class="btn2" href="javascript:webGoBack()"><span><tctl:msg key="comn.prelist" bundle="common"/></span></a>
					</div>
					<div class="btn_r">
				...
				<div class="mail_write_wrap">
					...
					<table class="reserv_info">
						...
						<tr>
							...
							<td><input type="text" name="location" id="location" class="it_full" value="${calendarInfoVo.location}"/></td>
						</tr>
						<tr>
							<th><tctl:msg key="scheduler.search.content" bundle="scheduler"/></th>
							<td><textarea name="content" id="content" rows="6" cols="" class="tx_full">${fn:replace(calendarInfoVo.content,"<br/>","")}</textarea></td>
						</tr>
						<tr>
							<th></th>
		...
		<%@include file="/hybrid/calendar/calendarBottom.jsp"%>
