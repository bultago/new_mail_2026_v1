	...
	<head>
		...
		<script type="text/javascript">			
			function moveto_page(page) {
				var url="/hybrid/bbs/bbsContentList.do";
				var paramArray = [];
	...
	<body>
		<div class="wrapper">		
			...
			<div class="container">	
				...
				<div class="title_box">
					<div class="btn_l"><a class="btn2" href="/hybrid/bbs/bbsList.do"><span><tctl:msg key="bbs.mobile.001" bundle="bbs"/></span></a></div>
					<div class="btn_r"><a class="btn2" href="/hybrid/bbs/bbsContentWrite.do?bbsId=${bbsContentInfo.bbsId}" id="wirteBbsBtnT"><span><tctl:msg key="bbs.write" bundle="bbs"/></span></a></div>
				</div>
				<ul class="normal_type board_list">
					...
					<li>
						<a href="/hybrid/bbs/bbsContentView.do?bbsId=${bbsContentInfo.bbsId}&contentId=${noticeContent.contentId}&parentId=${noticeContent.parentId}&orderNo=${noticeContent.orderNo}">
				...
				<div class="title_box">
					<div class="btn_l"><a class="btn2" href="/hybrid/bbs/bbsList.do"><span><tctl:msg key="bbs.mobile.001" bundle="bbs"/></span></a></div>
					<div class="btn_r"><a class="btn2" href="/hybrid/bbs/bbsContentWrite.do?bbsId=${bbsContentInfo.bbsId}" id="wirteBbsBtnB"><span><tctl:msg key="bbs.write" bundle="bbs"/></span></a></div>
				</div>
				<form name="searchForm" id="bbsSearchForm" onsubmit="return false;">
