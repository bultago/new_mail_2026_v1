            ...
            <div class="TM_content_wrapper">
                <div class="TM_mail_content">   
                    ...
                    <table cellpadding="0" border="0" id="mail_rcpt" class="TM_tableList">
                        ...
                        <tctl:msg key="mail.to"/>&nbsp;<input type="checkbox" name="reply_me"  id="reply_me" onclick="insertMySelf(this)"><label for="reply_me"><span class="TM_sitem" style="cursor:pointer;"><tctl:msg key="mail.myself"/></span></label>                 
                        </th>
                    ...
                    <table cellpadding="0" border="0" id="mail_rcpt" class="TM_tableList">
                        ...
                        <th><tctl:msg key="mail.subject"/></th>
                        <td colspan="3" >
                            <input class="TM_write_input"  type="text" name="subject" id="subject" value="${writeBean.subject}">
                        </td>
                        </tr>
                    </table>
                        ...
                        <div class="TM_mail_toolbar">
                            <table cellpadding="0" cellspacing="0" border="0">                  
                                ...
                                <div id="html5FileUploader">
                                    ...
                                    <script>
                                        var html5FileUploaderParams = {"drawArea":"html5FileUploaderArea", "callLocation":"mail-html", "locale":LOCALE};                       
