...
- [HARD] Backend Strategy: Follow plans in `new_mail_2026_v1/plan/`. STRICTLY Adhere to TDD & DDD.
  - Domain First -> Test First -> Implement
  - Refer to `01_STRATEGY.md` before writing backend code.
...
- [HARD] Clearly state when web search returns no results or encounters technical issues
