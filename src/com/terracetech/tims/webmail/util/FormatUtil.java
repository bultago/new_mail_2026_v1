...
public class FormatUtil {
	 ...
	 * 임시 디렉토리명을 반환한다.<br>
	 * 
	 * <li>임시 디렉토리 포멧은 "20081211121"같은 형식으로 10분 단위의 날짜 표현식이다.</li>
	 * <li>하루 최대 144개의 임시 디렉토리가 생성 될 수 있다.</li>
	 * <li>성능 향상을 위해서 현재 시간을 체크해서 마지막 체크 시간보다 10분이상 경과되었을 경우
	 * 	새로 시간을 설정해서 dir명을 만들고 10분이 초과 하지 않았을 경우에는 기존에 생성한 dir명을 반환한다.
	 * </li>
	 * <p> 
	 * @return lastChekTimeStr 임시디렉토리 명;
	 */
