...
public class DownloadAllNoticeAttachAction extends BaseAction {
	/**
	 * 
	 */
	private static final long serialVersionUID = 8821240702899557776L;
	...
	private final static String NOTICE_NAME = "notice";
	private long uid = 0;
	...
	public DownloadAllNoticeAttachAction(boolean authcheck) {
	...
	public String execute() throws Exception{
		...
		try {
			...
			String uniqueDir = NOTICE_NAME + "_" + System.currentTimeMillis();
