...
@Controller("mobileBbsContentViewReplyController")
public class BbsContentViewReplyController {
	@Autowired
	...
	public String execute(
		...
		BoardContentVO originalContent = bbsManager.getBbsContent(Integer.parseInt(contentId));
